...
namespace DyrdaIo.FirstPersonController
{
    ...
    public class FirstPersonController : MonoBehaviour, ICharacterSignals
    {
        ...
        [Header("References")]
        [SerializeField] public  FirstPersonControllerInput firstPersonControllerInput;
        ...
        public CurrentlyActive currentlyActive=CurrentlyActive.Player;
        #endregion
        ...
        public CurrentlyActive GetCurrentlyActive()
        {
